...
let imgList = new Array(0);
let syntaxList = new Array(0);
let converList = new Array(0);
  ...
  created() {
    listData =
      localStorage.getItem("listData") === null || undefined
        ...
        : JSON.parse(localStorage.getItem("listData"));
    syntaxList =
      localStorage.getItem("syntaxList") === null || undefined
        ? []
        : JSON.parse(localStorage.getItem("syntaxList"));
  },
  components: {},
  computed: {
    //取得使用者資料
